...
const Create = () => {
  ...
  const { mutate } = useCreateNewHeadboardVariant(id);
    ...
    <div className={styles.rightsidebar}>
      ...
      <main className={styles.main}>
        <div className={styles.containerbox}>
          <div className={styles.mainheading}>Create Variants</div>
          {/* <div
          ...
          <div className="grid">
            <Button onClick={handleProductUpload}>Submit Datas</Button>
          </div>
        </div>
      </main>
    </div>
